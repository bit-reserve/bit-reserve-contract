...
/// @title   sBTR
/// @notice  Staked BTRtor
contract sBTR is IsBTR, ERC20 {
    /// EVENTS ///
    ...
    constructor() ERC20("Staked BTR", "sBTR") {
    ...
    /// @notice       Transfer sBTR from msg.sender
    /// @param to     Address sending sBTR to
    /// @param value  Amount of sBTR to send
    function transfer(
        address to,
        uint256 value
    ...
    /// @notice       Transfer sBTR
    /// @param from   Address sending sBTR from
    /// @param to     Address sending sBTR to
    /// @param value  Amount of sBTR to send
    ...
    /// @notice        Returns calculation of gons for amount of sBTR
    /// @param amount  Amount of sBTR to calculate gons for
    ...
    /// @param gons  Amount of gons to calculate sBTR for
    ...
    /// @notice  Returns sBTR circulating supply (Total Supply - Staking Contract Balance)
    function circulatingSupply() public view override returns (uint256)  {
        return _totalSupply - balanceOf(stakingContract);
    }

    /// @notice  Returns current sBTR index
